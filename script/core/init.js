(function (App) {
    App.Core.InitCmd="l;i2;score;special;set custom_hp 1;set no_autosave 1;set area_detail 1;yield no;set hpbrief long,report;hpbrief;gmcp Status on;gmcp Move on;gmcp Combat on"
